...
// These are the .env variables that we want to expose on the settings page
exports.editableEnvVariables = [
    "GAME_LENGTH",
    "ROOMCODE_BYTES",
    "MAX_MULTIBOARD_GEN",
...
exports.setEnvValue = function(key, value) {
    ...
    if (target == -1)
    {
        // Value wasn't in the file yet so add it to the list
